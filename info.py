...
PRIME_MEMBERS_LOGS = int(environ.get('-1002599639831'))
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '6969391120').split()]
